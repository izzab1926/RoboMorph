...
class LinearDynamicalDataset(IterableDataset):
    def __init__(self, nx=18, nu=9, ny=3, seq_len=400, strictly_proper=True, dtype="float32", normalize=True):
...
if __name__ == "__main__":
    train_ds = WHDataset(nx=1, seq_len=4, mag_range=(0.5, 0.96),
                         phase_range=(0, math.pi / 3),
                         system_seed=42, data_seed=445, fixed_system=False,normalize=False)
